...
public sealed class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    public DbSet<ProductComboSlotPresetOption>             ProductComboSlotPresetOption             => Set<ProductComboSlotPresetOption>();
    ...
    public DbSet<SalesOrderLineComboSlotSelection>        SalesOrderLineComboSlotSelection        => Set<SalesOrderLineComboSlotSelection>();
    public DbSet<SalesOrderLineSlotOption>                SalesOrderLineSlotOption                => Set<SalesOrderLineSlotOption>();
    ...
    public DbSet<SalesInvoiceLineComboSlotSelection>      SalesInvoiceLineComboSlotSelection      => Set<SalesInvoiceLineComboSlotSelection>();
