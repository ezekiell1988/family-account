...
namespace FamilyAccountApi.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260320065636_AddBankStatementImportSystem")]
    partial class AddBankStatementImportSystem
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("bankStatementImport", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_bankStatementImport_status", "status IN ('Pending', 'Processing', 'Completed', 'Failed')");
                        });
                });
