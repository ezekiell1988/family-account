        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    idCostCenter = table.Column<int>(type: "int", nullable: true, comment: "Centro de costo asignado manualmente a la transacción (opcional)"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_bankStatementTransaction_costCenter_idCostCenter",
                        column: x => x.idCostCenter,
                        principalTable: "costCenter",
                        principalColumn: "idCostCenter",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 141, false, "5.16", 5, true, 2, "Tecnología", "Gasto" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 89, true, "5.11.04", 100, true, 3, "Gastos Administrativos BCR", "Gasto" },
                    ...
                    { 139, true, "5.5.07", 92, true, 3, "Seguro Protección BAC", "Gasto" },
                    { 140, true, "5.8.07", 95, true, 3, "Suscripciones Varias", "Gasto" },
                    { 142, true, "5.16.01", 141, true, 3, "Compras Tecnología (ICON / Apple)", "Gasto" },
                    { 146, true, "4.4.02", 101, true, 3, "Intereses Ganados - Sobres BCR", "Ingreso" },
                    { 147, true, "4.4.03", 101, true, 3, "Intereses Ganados - Ahorros BCR", "Ingreso" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 143, true, "2.1.01.08", 28, true, 4, "BAC - TC 5466-8608 Financiamientos Tasa Cero (₡)", "Pasivo" },
                    { 144, true, "2.1.01.09", 28, true, 4, "BAC - TC 5466-8608 Financiamientos Tasa Cero ($)", "Pasivo" },
                    { 145, true, "2.1.01.10", 28, true, 4, "BAC - TC 5491-6515 Financiamientos Tasa Cero (₡)", "Pasivo" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_bankStatementTransaction_idCostCenter",
                table: "bankStatementTransaction",
                column: "idCostCenter");
