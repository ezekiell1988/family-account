...
public interface ISalesOrderService
{
    ...
    Task<SalesOrderResponse> CreateAsync(CreateSalesOrderRequest request, CancellationToken ct = default);
    Task<SalesOrderResponse?> UpdateAsync(int idSalesOrder, UpdateSalesOrderRequest request, CancellationToken ct = default);
