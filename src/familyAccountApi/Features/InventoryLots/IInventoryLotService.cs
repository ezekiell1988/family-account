...
{
    Task<IReadOnlyList<InventoryLotResponse>> GetByProductAsync(int idProduct, int? idWarehouse = null, CancellationToken ct = default);
    ...
    /// Si se especifica idWarehouse, restringe la búsqueda a ese almacén.
    /// </summary>
    Task<InventoryLotResponse?> GetSuggestedLotAsync(int idProduct, DateOnly referenceDate, int? idWarehouse = null, CancellationToken ct = default);
    /// <summary>
