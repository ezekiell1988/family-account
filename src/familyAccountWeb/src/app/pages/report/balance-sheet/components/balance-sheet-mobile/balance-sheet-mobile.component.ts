...
import {
  playOutline, calendarOutline, businessOutline, homeOutline,
  personOutline, warningOutline, closeOutline, analyticsOutline,
} from 'ionicons/icons';
import {
  IonContent,
  IonRefresher,
...
@Component({
  selector: 'app-balance-sheet-mobile',
  host: { class: 'ion-page' },
  ...
  templateUrl: './balance-sheet-mobile.component.html',
})
export class BalanceSheetMobileComponent {
  ...
  constructor() {
    addIcons({ playOutline, calendarOutline, businessOutline, homeOutline, personOutline, warningOutline, closeOutline, analyticsOutline });
  }
